...
// Endpoint: AI Islamic Teacher (এআই শিক্ষক) - solves Quran, Hadith, Mas'ala, History, and Dua questions
app.post("/api/ai-teacher", async (req, res) => {
  const { question, category, chatHistory } = req.body;
  if (!question || typeof question !== "string") {
    return res.status(400).json({ error: "কোনো প্রশ্ন প্রদান করা হয়নি।" });
  }

  try {
    const genAI = getGenAI();

    // Prepare contextual historical thread if available
    const historyText = Array.isArray(chatHistory) 
      ? chatHistory.map((h: any) => `${h.role === "user" ? "User" : "AI Teacher"}: ${h.content}`).join("\n")
      : "";
...
অনুগ্রহ করে একজন অত্যন্ত প্রাজ্ঞ, সংযত, বিনয়ী ও নির্ভরযোগ্য ইসলামিক শিক্ষকের (AI Scholar/Mufti) ন্যায় এই প্রশ্নের চমৎকার এবং তথ্যবহুল উত্তর প্রদান করুন।

আপনার জন্য কঠোর নিয়মাবলী:
১. শুধুমাত্র আল-কুরআন, হাদীস সমগ্র, ফিকহ ও মাসয়ালা-মাসায়েল, ইসলামের ইতিহাস, এবং দু'আ ও যিকর সম্পর্কিত বিষয়ের সমাধান করুন।
২. যদি ব্যবহারকারীর প্রশ্নটি ইসলামিক বিষয় বহির্ভূত হয় (যেমন: কোডিং, সাধারণ বিজ্ঞান, প্রযুক্তি, গল্প, বিনোদন, আধুনিক রাজনীতি বা অন্য যেকোনো অসংলগ্ন প্রশ্ন), তবে অত্যন্ত বিনম্রতার সাথে দুঃখ প্রকাশ করে বলুন যে আপনি একজন উৎসর্গীকৃতি দ্বীনি এআই শিক্ষক এবং আপনার পরিধি শুধু আল-কুরআন, হাদীস, মাসয়ালা, ইসলামের ইতিহাস ও দুয়ার মাঝেই সীমাবদ্ধ। আপনার উত্তরের এই শিষ্টাচারপূর্ণ জবাবটিও "answer" কী-তে পাঠাতে হবে এবং "verses" ফাঁকা থাকবে।
৩. উত্তর প্রদানের সময় নির্ভরযোগ্য কিতাব ও গ্রন্থের বরাত দিন (যেমন: বুখারী, মুসলিম, সূরা আল-বাকারা ইত্যাদি)।
৪. প্রাসঙ্গিক কুরআন আয়াত বা হাদীস থাকলে অবশ্যই তা "verses" অ্যারে-তে আরবী টেক্সট, বাংলা অনুবাদ ও উৎস রেফারেন্স সহ যুক্ত করুন।
৫. উত্তরটি সাজানোর সময় সুন্দর প্যারাগ্রাফ এবং বোল্ড-ইটালিকস ব্যবহার করুন (Markdown Support)।
৬. সুন্দর ও মার্জিত ইসলামিক অভিবাদন (যেমন: আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ) এবং বিদায় সম্ভাষণ বা শুভকামনা দিয়ে শুরু ও শেষ করুন।

নিম্নলিখিত নির্দিষ্ট JSON স্কিমা অনুযায়ী নিখুঁত বাংলা ভাষায় উত্তরটি প্রদান করুন:
{
  "answer": "বিস্তারিত ও প্রাজ্ঞ উত্তরটি মার্কারডাউন ফরম্যাটে সুন্দর সাবহেডিং সহ এখানে লিখুন (শুদ্ধ বাংলা ভাষায়)।",
  "verses": [
    {
      "ref": "দলিল বা বইয়ের নাম (যেমন: সূরা আল-কাওসার: ৩ অথবা সহীহ মুসলিম: হাদিস নম্বর ১২৩)",
      "ar": "মূল আরবী আয়াত বা হাদীসের আরবী অংশ",
      "bn": "আয়াত বা হাদীসের সঠিক বাংলা অর্থ ও অনুবাদ"
    }
  ],
  "suggestions": [
    "প্রশ্নটির সাথে সম্পর্কিত ১টি চমৎকার পরবর্তী বা অনুসারী প্রশ্ন",
    "প্রশ্নটির গভীর কোনো প্রেক্ষাপট নিয়ে ২য় প্রাসঙ্গিক প্রশ্ন",
    "৩য় কোনো দোয়া বা মাসয়ালা বিষয়ক প্রাসঙ্গিক প্রশ্ন"
  ]
}
`;
    ...
    const response = await genAI.models.generateContent({
      ...
      config: {
        ...
        responseSchema: {
          ...
          required: ["answer", "verses", "suggestions"]
        }
      }
    });
    ...
    console.error("AI Teacher API Error:", err.message);
    const fallback = {
      answer: "আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ। দুঃখিত, তথ্য প্রক্রিয়াকরণ বা নেটওয়ার্ক সংযোগে সাময়িক ত্রুটির কারণে আপনার চমৎকার প্রশ্নটি এআই শিক্ষকের নিকট পৌঁছানো সম্ভব হয়নি। অনুগ্রহ করে কিছুক্ষণ পর পুনরায় চেষ্টা করুন। আল্লাহ আপনার জ্ঞান বৃদ্ধি করুন। আমীন।",
      verses: [
        {
          ref: "সূরা ত্বা-হা: ২০:১১৪",
          ar: "وَقُل رَّبِّ زِدْنِي عِلْمًا",
          bn: "এবং বলুন, হে আমার পালনকর্তা! আমার জ্ঞান বৃদ্ধি করুন।"
        }
      ],
      suggestions: [
        "ঈমান বৃদ্ধি করার উপায় কি?",
        "তাহাজ্জুদ নামাজের নিয়ম ও গুরুত্ব জানতে চাই",
        "ইসলামে দ্বীনি ইলম বা জ্ঞান অর্জনের আবশ্যকতা কতটুকু?"
      ]
    };
    return res.json(fallback);
  }
